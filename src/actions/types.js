...
export const LOGIN_USER_SUCCESS_FACEBOOK = 'login_user_success_facebook';
export const LOGIN_USER_FAIL = 'login_user_fail';
export const LOGIN_USER = 'login_user';
export const LOGOUT = 'logout';
export const LOGIN_IS_LOADING = 'login_is_loading';

/* export const BASE_URL = 'http://192.168.0.49:8080/';
export const API_URL_LOGIN = 'http://192.168.0.49:8080/JWTProvider';
export const API_URL_VALIDATE_TOKEN = 'http://192.168.0.49:8080/JWTValidate'; */

export const BASE_URL = 'https://meuvisualsemijoias.net/';
export const API_URL_LOGIN = 'https://meuvisualsemijoias.net/JWTProvider';
